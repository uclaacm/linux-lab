...
function Intro(): JSX.Element {
  return (
    <div className="intro-container">
      ...
      <p className="body">
      In this learning lab, you will be learning how to speak the language of Linux or
      learning basic commands that often apply through a command-line interface (CLI).
      These commands will not only teach you how to move about the Linux file system but
       also teach you how to command the computer to do what you want!
      </p>
      ...
      <img className="image-box" src={posixFileSystem} alt ="posix file system" width="60%"/>
